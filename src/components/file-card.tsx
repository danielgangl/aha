...
function ViewedCheckbox({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <span className="inline-flex h-[14px] w-[14px] items-center justify-center rounded-[3px] border-[1.5px] border-[var(--line-3)] bg-[var(--surface)] font-mono text-[10px] group-data-[on=true]/viewed:border-[var(--ink)] group-data-[on=true]/viewed:bg-[var(--ink)] group-data-[on=true]/viewed:text-[var(--bg)] group-data-[on=true]/viewed:after:content-['✓']" />{" "}
      <span>Viewed</span>
    </div>
  );
}
